...
void loop() {
  ...
  if((currentDateTime.minute % 4 == 0) && (currentDateTime.second == 0)){
    webInterface();  //Sends URL Get request to wake up Radio and ESP32 at 4 minute interval
